...
def polarity_calc(df, country='US', like_prediction='Per Tweet'):
    df_segmented_year = df.copy()
    df_segmented_year['nlikes'] = df['nlikes'] + 1
...
def plot_map(df, country='US', like_prediction='Per Tweet'):
