...
from green_mood_tracker_app.datavisstreamlit import altair_plot, plot_map
from green_mood_tracker_app.clustering import lda_wordcloud
...
img = st.image('green_mood_tracker_app/assets/green_mood_tracker_logo.png',
...
def sl_predict(country_prediction, topic_prediction, date, local=False):
    ...
    filepath_pred = 'green_mood_tracker_app/raw_data/predictions_twint_test/uk-data-testv0.csv'
